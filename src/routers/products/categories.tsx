  ...
  return (
    <LayoutWapper size="small">
      <div className="grid grid-cols-[300px_1fr] gap-6 p-6">
        <div className="bg-background max-h-screen scroll-smooth p-3 pb-20 overflow-y-auto rounded-lg border-r-2">
            ...
            <div className="mt-10">
              <Pagination>
                <PaginationContent>
                  ...
                  {Array.from({
                    length: Math.ceil(data?.total! / LIMIT_PAE_PRODUCT_LIST),
                  }).map((_, p) => (
