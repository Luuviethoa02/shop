        ...
        <>
            ...
            >
                <div className="container mx-auto px-4">
                    ...
                    >
                        <p className="mb-6">
                            Tại <span className="font-semibold">Shop VH</span>, chúng tôi không chỉ cung cấp sản phẩm chất lượng mà còn đem đến những dịch vụ tốt nhất.
                            Với cam kết luôn làm hài lòng khách hàng, chúng tôi tự hào về đội ngũ tận tâm, chuyên nghiệp.
                        </p>
                        <p className="mb-6">
                            Hãy cùng khám phá các dịch vụ của chúng tôi từ tư vấn thời trang cá nhân, giao hàng nhanh chóng,
                            đến trải nghiệm mua sắm trực tuyến thân thiện và dễ dàng.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-gray-600">
                                Chúng tôi cung cấp dịch vụ tư vấn thời trang theo phong cách và nhu cầu cá nhân của bạn, đảm bảo bạn luôn tỏa sáng.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-600">
                                Chúng tôi cam kết giao hàng nhanh nhất có thể với các phương thức vận chuyển hiện đại, đảm bảo an toàn và nhanh chóng.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-600">
                                Đội ngũ hỗ trợ khách hàng của chúng tôi luôn sẵn sàng giải đáp mọi thắc mắc của bạn bất cứ lúc nào.
                            </p>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="p-6 bg-white rounded-lg shadow-md">
                                <h3 className="text-xl font-semibold mb-4">Mua sắm trực tuyến</h3>
                                <p>
                                    Chúng tôi tối ưu hóa trải nghiệm mua sắm trực tuyến với giao diện thân thiện, dễ sử dụng và nhiều tính năng tiện lợi.
                                </p>
                            </div>
                            <div className="p-6 bg-white rounded-lg shadow-md">
                                <h3 className="text-xl font-semibold mb-4">Chính sách hoàn trả</h3>
                                <p>
                                    Bạn hoàn toàn yên tâm với chính sách hoàn trả dễ dàng nếu sản phẩm không như mong đợi.
                                </p>
                            </div>
                            <div className="p-6 bg-white rounded-lg shadow-md">
                                <h3 className="text-xl font-semibold mb-4">Hỗ trợ khách hàng</h3>
                                <p>
                                    Chúng tôi luôn ở đây để hỗ trợ bạn bất cứ lúc nào, với đội ngũ chuyên nghiệp và tận tâm.
                                </p>
                            </div>
                        </div>
                    </motion.div>
