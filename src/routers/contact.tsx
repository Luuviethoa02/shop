...
export const ContactRoute = () => {
  ...
  return (
    <>
      <SEO title="Liên hệ" description="this is the contact page of the shop" />
      <div className="min-h-screen bg-pink-50 py-12">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            Đội ngũ của <span className="font-semibold">Shop VH</span> luôn sẵn
            sàng hỗ trợ bạn!
          </motion.p>
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-2">
              Số điện thoại: {convertToVietnamesePhone("0977545454")}
            </p>
